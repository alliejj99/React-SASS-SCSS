  ...
  return (
    <aside className="small_sidebar">
      <div className="small_sidebar_container">
        <Link to="/" data-tooltipid="sidebar" data-data-tooltip-content="Home">
        ...
        <Link
          to="/feed/explore"
          data-tooltipid="sidebar"
          data-data-tooltip-content="Explore"
        >
          <div className="sidebar_icon_container">
        ...
        <Link
          ...
          data-tooltipid="sidebar"
          data-data-tooltip-content="Subscriptions"
        >
          <div className="sidebar_icon_container">
